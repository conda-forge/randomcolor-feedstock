About randomcolor-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/randomcolor-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1825&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/randomcolor-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `randomcolor` can be installed with `conda`:
...
```
mamba install randomcolor
```

It is possible to list all of the versions of `randomcolor` available on your platform with `conda`:
...
```
mamba search randomcolor --channel conda-forge
```
...
mamba repoquery search randomcolor --channel conda-forge

# List packages depending on `randomcolor`:
mamba repoquery whoneeds randomcolor --channel conda-forge

# List dependencies of `randomcolor`:
mamba repoquery depends randomcolor --channel conda-forge
```
